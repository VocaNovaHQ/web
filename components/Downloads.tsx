...
const platforms: Platform[] = [
  ...
  {
    key: "macos",
    name: "VocaNova for macOS",
    tagline: "어떤 앱에서든, 단축키 한 번",
    description:
  ...
  {
    key: "ios",
    name: "VocaNova for iOS",
    tagline: "손 안의 스마트 단어장",
    description:
...
export function Downloads() {
  return (
    <section id="downloads" className="section relative">
      <div className="absolute inset-x-0 top-0 -z-10 h-80 bg-hero-glow" aria-hidden />
      <div className="container-x">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-ink-600 md:text-lg">
            세 플랫폼 모두 무료로 제공됩니다. 같은 계정으로 로그인하면
            단어장이 자동으로 동기화됩니다.
          </p>
        </div>
  ...
  return (
    <article className="card relative overflow-hidden p-7">
      ...
      <div className="relative">
        ...
        <p className="mt-1 text-sm font-medium text-ink-500">{platform.tagline}</p>
